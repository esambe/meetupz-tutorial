...
class MeetupDetails extends Component {
    ...
    getMeetup() {
        ...
        axios.get(`http://localhost:3000/api/meetups/${meetupId}?access_token=${global.LoggedUser.token}`)
        .then( response => {
    ...
    onDelete() {
        ...
        axios.delete(`http://localhost:3000/api/meetups/${meetupId}?access_token=${global.LoggedUser.token}`)
        .then( response => {
